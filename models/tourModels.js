...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [10, 'A tour must more or equal than 10 characters'],
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message: 'Discount price ({VALUE}) should be less than price value',
      },
    },
    summary: {
      type: String,
...
// tourSchema.pre('save', async function (next) {Ye code embedding kr rha hai tour or user me but hame child referencing use karni
